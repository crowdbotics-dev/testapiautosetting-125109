...
## Project Structure
    ...
    ├── testapiautosetting_125109  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125109`
...
2. Clone this repo and `cd testapiautosetting_125109`
